...
if ($params->get('displayType') == 'modal')
{
    ...
    echo '<div class="sourcecoast sclogin-modal-links sclogin" title="Вход/Регистрация"><a ' . $loginClass . ' href="#login-modal" role="button" data-toggle="' . $modalName . '">' . JText::_('MOD_SCLOGIN_LOGIN') . '</a>';
